...
const schema = {
    ...
    properties: {
        ...
        statusId: {type: "string", minLength: 32, maxLength: 32},
        // created, in progress, blocked, freezer, postponed, done
        ...
        createdDate: {type: "string", minLength: 32, maxLength: 32},
        startDate: {type: "string", minLength: 32, maxLength: 32},
        dueDate: {type: "string", minLength: 32, maxLength: 32},

        repetitive: {
            type: "json",
            active: {type: "boolean", default: true},
            period: {type: "string", minLength: 32, maxLength: 32},
            listCompletedDates: {
                type: "array",
                items: {
                    type: "object",
                    properties: {
                        competedDate: {type: "string", minLength: 32, maxLength: 32}
                    },
